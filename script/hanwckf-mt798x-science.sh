...
sed -i "s/192\.168\.[0-9]*\.[0-9]*/192.168.91.1/g" $(find ./feeds/luci/modules/luci-mod-system/ -type f -name "flash.js")
...
rm -rf feeds/packages/net/{adguardhome,smartdns,tailscale,open-app-filter}
